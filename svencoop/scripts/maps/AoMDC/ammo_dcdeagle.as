...
class ammo_dcdeagle : ScriptBasePlayerAmmoEntity
{
	...
	{ 
		...
		{
			g_EntityFuncs.SetModel( self, "models/AoMDC/items/w_deagleclip.mdl" );
		}
		else	//Custom model
	...
	void Precache()
	{
		...
		if( string( self.pev.model ).IsEmpty() )
			g_Game.PrecacheModel("models/AoMDC/items/w_deagleclip.mdl");
		else	//Custom model
	...
	{ 
		if (pOther.GiveAmmo( AMMO_DEAGLE_GIVE, "357", AMMO_DEAGLE_MAX_CARRY ) != -1)
		{
