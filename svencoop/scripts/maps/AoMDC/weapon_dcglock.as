...
class weapon_dcglock : ScriptBasePlayerWeaponEntity
{
	...
	bool AddToPlayer( CBasePlayer@ pPlayer )
	{
		...
		self.pev.message = ""; // Reset the owner
	...
	int DeleteNearbyDuplicatesByOwner()
	{
		...
		CBaseEntity@ pDuplicate = g_EntityFuncs.FindEntityInSphere(pStartEntity, self.pev.origin, 8192.0, m_iszOwnerId, "message");
...
void RegisterDCGlock()
{
	...
	g_ItemRegistry.RegisterWeapon( GetDCGlockName(), "AoMDC", "9mm" );
}
