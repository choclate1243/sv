...
class weapon_dcuzi : ScriptBasePlayerWeaponEntity
{
	...
	bool AddToPlayer( CBasePlayer@ pPlayer )
	{
		...
		self.pev.globalname = ""; // Reset the owner
	...
	int DeleteNearbyDuplicatesByOwner()
	{
		...
		CBaseEntity@ pDuplicate = g_EntityFuncs.FindEntityInSphere(pStartEntity, self.pev.origin, 8192.0, m_iszOwnerId, "globalname");
