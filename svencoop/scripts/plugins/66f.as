...
CBaseEntity@ getCaller(string name, bool recurse=true)
{
	...
	do {
		...
		{			
			if (ent2.pev.targetname == "trigger_percent6")
				continue;
...
void checkForChangelevel()
{
	...
	do {
		...
		if (ent is null)
			break;
		if (ent.pev.targetname != "trigger_percent6" and ent.pev.classname != "game_end")
			continue;

		if (ent.pev.targetname == "trigger_percent6" and ent.pev.solid == SOLID_BSP)
		...
		if (isTriggered and ent.pev.targetname == "trigger_percent6" and 
